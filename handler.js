...
module.exports = {
    async handler(chatUpdate) {
        ...
        global.packname = 'FantasyBot'
        global.author = 'FantasyBot By rull'
        //global.author = 'Bot By Rull'
        global.wm2 = global.data.namabot + ' ' + global.data.owner
        global.wm = namabot + ' 𝑭𝑨𝑵𝑻𝑨𝑺𝒀𝑩𝑶𝑻'
        global.colong1 = 'Ciss 📸'
        global.colong2 = '𝑩𝒀 𝑭𝑨𝑵𝑻𝑨𝑺𝒀 𝑩𝑶𝑻'
        global.kontak2 = [
        ['6285785845416', '𝑹𝑈𝐿𝐿', 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'rullkanaeru@gmail.com', true],
        ]
            ...
            case 'remove':
                if (chat.welcome) {
                    ...
                    for (let user of participants) {
                        let pp = 'https://telegra.ph/file/76f48a56a0b2eb7e740e4.jpg'
                        try {
...
global.dfail = async (type, m, conn) => {
    ...
    let msg = {
        ...
        owner: 'Perintah ini hanya dapat digunakan oleh _*Ownwer!1!1!*_',
